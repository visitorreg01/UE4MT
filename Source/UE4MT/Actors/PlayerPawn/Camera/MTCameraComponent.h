...
public:
    ...
    * @param	DownTime			Time pressed
    */
    void OnPinchUpdate(class UMTInput* InputHandler, const FVector2D& ScreenPosition1, const FVector2D& ScreenPosition2, float DownTime);
