...
#include "UE4MT.h"
#include "MTSpectatorPlayerController.generated.h"

class AMTSpectatorPawn;
class UMTCameraComponent;
	
UCLASS()
class AMTSpectatorPlayerController : public APlayerController
{
...
private:
	...
	UMTCameraComponent* GetCameraComponent() const;
};
