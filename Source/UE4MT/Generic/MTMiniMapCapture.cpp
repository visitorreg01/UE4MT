...
#include "UE4MT.h"
#include "MTMiniMapCapture.h"


AMTMiniMapCapture::AMTMiniMapCapture(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AMTMiniMapCapture::BeginPlay()
{
	// @todo clean up
	Super::BeginPlay();
	...
	AMTGameState* const MyGameState = GetWorld()->GetGameState<AMTGameState>();
...
void AMTMiniMapCapture::UpdateWorldBounds()
{
    AMTGameState* const MyGameState = GetWorld()->GetGameState<AMTGameState>();
	if( MyGameState != nullptr )	
	{
...
void AMTMiniMapCapture::Tick(float DeltaSeconds)
{
...
#if WITH_EDITOR
void AMTMiniMapCapture::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void AMTMiniMapCapture::EditorApplyRotation(const FRotator& DeltaRotation, bool bAltDown, bool bShiftDown, bool bCtrlDown)
{
